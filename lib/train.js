...
exports.Train = ( function () {
    ...
    tproto.shift = function () {
        ...
        if ( me.hpos === qhead.length ) {
            if ( me.roll ) {
                ...
                // concat roll and head arrays
                me.qroll.push.apply( me.qroll, me.qhead );
            }
    ...
    tproto.pop = function ( k ) {
        ...
        if ( hlen < l ) {
            ...
            me.qhead = [];
            return qhead.splice( hpos ).concat( qtail.splice( 0, l - hlen ) );
        }
        // hlen >= l, cut head from start, then slice out old elements
        return qhead.splice( 0, hpos + l ).slice( hpos );
    };
